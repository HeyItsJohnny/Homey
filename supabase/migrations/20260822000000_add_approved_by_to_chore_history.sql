...
begin
    ...
    with activities as (
        ...
        select
            ...
            case
                when ca.decision = 'approved'::public.chore_approval_decision and reviewer.display_name is not null then 'Approved By ' || reviewer.display_name
